...
export default function RCADashboard() {
  ...
  async function handleAnalyze(
    ...
    try {
      ...
      setError(
        "Unable to analyze equipment. Please try again."
      );
    } finally {
      setLoading(false);
    }
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 max-w-3xl text-[15px] leading-7 text-muted">
            ...
            inspection history, work orders, historical failures,
            OEM manuals and Knowledge Graph reasoning to predict
            equipment failures and recommend preventive maintenance.
          </p>
        </div>
        ...
        {error && (
          <div className="mt-6 rounded-xl border border-danger/30 bg-danger/10 p-4 text-danger">
            {error}
          </div>
        )}
