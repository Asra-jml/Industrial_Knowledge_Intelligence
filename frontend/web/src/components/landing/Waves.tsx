...
const Waves: React.FC<WavesProps> = ({
  ...
  const [initialNoise] = React.useState(() => new Noise(Math.random()));
  const noiseRef = useRef(initialNoise);
  ...
  return (
    ...
    >
      <div
        className="absolute top-0 left-0 bg-[#3b82f6]/20 rounded-full w-[0.5rem] h-[0.5rem] blur-xl"
        style={{
